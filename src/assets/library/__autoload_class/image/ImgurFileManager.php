...
namespace vendor\ehex\easycore\assets\library\__autoload_class\image;
...
class ImgurFileManager
{
    ...
    {
        $this->client_id = env('IMGUR_CLIENT_ID');
        $this->client_secret = env('IMGUR_CLIENT_SECRET');
        return $this;
        //Console1::popupAny([$this->client_id, $this->client_secret]);
    }


    public function testUpload($imgLink = 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/1200px-Apple_logo_black.svg.png')
    {
        return $this->upload($imgLink);
    }
    ...
    {
        return isset($this->response) ? $this->response->data->link : null;
    }
    ...
    {
        return isset($this->response) ? $this->response->data->size : null;
    }
    ...
    {
        return isset($this->response) ? $this->response->data->type : null;
    }
    ...
    {
        return isset($this->response) ? $this->response->data->width : null;
    }
    ...
    {
        return isset($this->response) ? $this->response->data->height : null;
    }
    ...
    {
        return isset($this->response) ? 'https://i.imgur.com/delete/' . $this->response->data->deletehash : null;
    }
     ...
     * @return null|string
     */
    public function makeDeleteLink($hashCode = null)
    {
        return $hashCode ? 'https://i.imgur.com/delete/' . $hashCode : null;
    }
     ...
     * @return string
     */
    static public function makeSizeThumb($url = null)
    {
        return static::makeSize($url, 'm');
    }
     ...
     * @return string
     */
    static public function makeSizeSmall($url = null)
    {
        return static::makeSize($url, 'l');
    }
