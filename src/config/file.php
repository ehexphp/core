 ...
 */
    ...
    *
    ...
    function file_session($fileName = null){
        ...
        return Global1::has('$__FILE_SESSION')?
            Global1::get('$__FILE_SESSION'):
     ...
     * @return bool
     */
    function file_session_save($name, $content, $forceReplace = false){
        if($forceReplace && file_session()->has($name)) file_session($name)->del($name);
        return file_session()->set($name, $content);
    }
